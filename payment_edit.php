        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <?php
                $id=$_GET['id'];    
                $w['id']=$id;
                $data=$mysqli->common_select_single('customer_payment','*',$w)['data'];
            ?>
              <!-- form start -->
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" value="<?= $data->customer_id ?>" name="customer_id" class="form-control" id="customer_id" placeholder="Enter customer id">
                      </div>
                    </div>
                  </div>
              ...
              <?php
                if($_POST){
                  $upwhere['id']=$id;
                  $result=$mysqli->common_update('customer_payment',$_POST,$upwhere);
                  if($result['error']){
                    $_SESSION['class']="danger";
                    $_SESSION['msg']=$result['msg'];
                    echo "<script> location.replace('$base_url/payment_update.php?id=$id')</script>";
                  }else{
