            ...
            <div class="card card-primary">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="sales_id" class="form-control" id="sales_id" placeholder="Enter sales id">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="date" name="pay_date" class="form-control" id="pay_date" placeholder="Enter pay date">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <?php
               if($_POST){
                 ...
                 $result=$mysqli->common_create('customer_payment',$_POST);
                 if($result['error']){
                   $_SESSION['class']="danger";
                   $_SESSION['msg']=$result['msg'];
                   echo "<script> location.replace('$base_url/payment_create.php')</script>";
                 }else{
